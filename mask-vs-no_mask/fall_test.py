...
model = load_model('/home/ale/Downloads/FaceDataset.h5')
...
cap = cv2.VideoCapture('/home/ale/Documents/304x304.mp4')
...
while(True):
    ...
    if preds[0][0] > 0.5:
        print("No Mascara",preds," FPS: ", 1.0/(time.time()-start_time), counter)
    else:
        print("Mascara",preds," FPS: ", 1.0/(time.time()-start_time), counter)
